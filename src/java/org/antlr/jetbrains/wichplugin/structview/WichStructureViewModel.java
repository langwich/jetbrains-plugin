...
public class WichStructureViewModel extends TextEditorBasedStructureViewModel {
	protected Editor editor;
	protected VirtualFile file;
	protected ParseTree parseTree;

	public WichStructureViewModel(Editor editor, VirtualFile file) {
		super(editor);
		this.editor = editor;
		this.file = file;
...
//			System.out.println("structview parse "+text.substring(0,5)+"...");
	...
	public Object getCurrentEditorElement() {
		...
		while ( p!=null && !(p instanceof WichParser.FunctionContext) ) {
			p = p.getParent();
		}
		if ( p!=null ) {
			return ((WichParser.FunctionContext)p).ID();
		}
		return null;
	}
	...
	public StructureViewTreeElement getRoot() {
		return new WichRootTreeElement(this,parseTree,file);
	}
